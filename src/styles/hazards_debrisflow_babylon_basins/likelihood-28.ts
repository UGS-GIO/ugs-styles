/** Babylon fire — debris-flow likelihood in the source basins for a 28 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'babylon-basins-28-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColor(28), 'fill-opacity': 0.75 },
    },
    {
        id: 'babylon-basins-28-line',
        type: 'line',
