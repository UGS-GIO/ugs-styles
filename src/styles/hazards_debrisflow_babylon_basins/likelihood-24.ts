/** Babylon fire — debris-flow likelihood in the source basins for a 24 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'babylon-basins-24-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColor(24), 'fill-opacity': 0.75 },
    },
    {
        id: 'babylon-basins-24-line',
        type: 'line',
