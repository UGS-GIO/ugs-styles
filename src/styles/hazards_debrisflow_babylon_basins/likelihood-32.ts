/** Babylon fire — debris-flow likelihood in the source basins for a 32 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'babylon-basins-32-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColor(32), 'fill-opacity': 0.75 },
    },
    {
        id: 'babylon-basins-32-line',
        type: 'line',
