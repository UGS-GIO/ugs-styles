/** Babylon fire — debris-flow likelihood in the source basins for a 20 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'babylon-basins-20-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColor(20), 'fill-opacity': 0.75 },
    },
    {
        id: 'babylon-basins-20-line',
        type: 'line',
