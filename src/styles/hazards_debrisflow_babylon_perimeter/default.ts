/** Babylon fire perimeter — context outline for the debris-flow assessment layers. */
import type { Binding, StyleLayer } from '../../types';

export const spec = {
    itemId: 'hazards_debrisflow_babylon_perimeter',
    render: 'default',
    kind: 'vector',
    assets: ['pmtiles'],
    title: 'Babylon fire perimeter',
...
const layers: StyleLayer[] = [
    {
        id: 'babylon-perimeter-fill',
        type: 'fill',
        paint: { 'fill-color': '#7f2704', 'fill-opacity': 0.06 },
    },
    {
        id: 'babylon-perimeter-line',
        type: 'line',
