/** Low Cottonwood — post-fire debris-flow runout extent for a 60 mm/h design storm. */
...
export const spec = {
    ...
    kind: 'vector',
    assets: ['pmtiles'],
    title: 'Debris-flow runout — 60 mm/h',
    field: 'dfsi_thr',
...
const scenario: ExpressionSpecification = ['==', ['number', ['get', 'i15'], -1], 60];
