// Seeded from live GeoServer: https://ugs-geoserver-prod-flbcoqv7oa-uc.a.run.app/geoserver/hazards/wms?service=WMS&version=1.1.1&request=GetStyles&layers=hazards:merged_displacement_contours_test_all&styles=hazards_insar_displacement_velocity (WMS GetStyles → geostyler, one-time capture).
