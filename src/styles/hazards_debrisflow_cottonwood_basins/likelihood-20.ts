/** Cottonwood — debris-flow likelihood in the source basins for a 20 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'cottonwood-basins-20-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColorEitherCase(20), 'fill-opacity': 0.75 },
    },
    {
        id: 'cottonwood-basins-20-line',
        type: 'line',
