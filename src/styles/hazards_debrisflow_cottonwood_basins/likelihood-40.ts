/** Cottonwood — debris-flow likelihood in the source basins for a 40 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'cottonwood-basins-40-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColorEitherCase(40), 'fill-opacity': 0.75 },
    },
    {
        id: 'cottonwood-basins-40-line',
        type: 'line',
