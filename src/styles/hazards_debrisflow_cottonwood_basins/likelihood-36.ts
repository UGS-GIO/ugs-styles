/** Cottonwood — debris-flow likelihood in the source basins for a 36 mm/h design storm. */
...
const layers: StyleLayer[] = [
    {
        id: 'cottonwood-basins-36-fill',
        type: 'fill',
        paint: { 'fill-color': likelihoodColorEitherCase(36), 'fill-opacity': 0.75 },
    },
    {
        id: 'cottonwood-basins-36-line',
        type: 'line',
